...
| 19 | Data and code availability | Partial | Data Availability; Code Availability; Table 1 | Exact source links added; add final public code/derived-data repository URL before submission. |
...
The unified English draft substantially addresses the STROBE-MR structure. Table 1, software-environment freeze, data/code availability draft, protocol-registration wording, and default funding/conflict statements have now been added. The main remaining gaps are submission-level rather than analytic: final public repository URL, target-journal formatting, author confirmation of funding/conflict declarations, and final reference-manager export.

## Priority Fixes Before Submission

1. Create or fill the final public code/derived-data repository URL, ideally with a Zenodo DOI.
